...
var UIController = (function() {
    ...
    return {
        ...
        displayBudget : function(item) {
            document.getElementsByClassName('budget-value').innerHTML = item.budget;
            document.getElementsByClassName('budget-income-value').innerHTML = item.incomeTotal;
            document.getElementsByClassName('budget-expenses-value').innerHTML = item.expenseTotal;           
        }
    };
}) (); // end of UIController
 ...
 */
var globalController = (function(budgetController, UIController) {
    ...
    var updateBudget = function() {
        ...
        // STEP 3 : display
        budgetController.displayBudget(budget);
    };
    ...
    var addBtnEvent = function() {
        ...
        //deleteBtn events bind: what happened if deleteBtn is clicked?
        var deleteBtnEvent = function() {
...
var init = function() {
    ...
    globalController.eventListener();
}
init();